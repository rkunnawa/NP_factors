...
cmsRun anaGenJet_HAD_cfg.py output="GenJet_HAD_R23457_5020_July8_Z2pt80to120.root" maxEvents="100000" processType="NSD" ptHatLow="80" ptHatHigh="120" sqrtS="5020" &> run_HAD_5020_80_120.log
