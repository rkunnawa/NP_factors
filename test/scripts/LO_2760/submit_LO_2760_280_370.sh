...
cmsRun anaGenJet_LO_cfg.py output="GenJet_LO_R23457_2760_July8_Z2pt280to370.root" maxEvents="100000" processType="NSD" ptHatLow="280" ptHatHigh="370" sqrtS="2760" &> run_LO_2760_280_370.log
