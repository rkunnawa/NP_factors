...
cmsRun anaGenJet_LO_cfg.py output="GenJet_LO_R23457_2760_July8_Z2pt0to15.root" maxEvents="100000" processType="MB" ptHatLow="0" ptHatHigh="15" sqrtS="2760" > run_LO_2760_0_15.log
