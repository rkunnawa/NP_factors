...
cmsRun anaGenJet_LO_cfg.py output="GenJet_LO_R23457_2760_July8_Z2pt15to30.root" maxEvents="100000" processType="NSD" ptHatLow="15" ptHatHigh="30" sqrtS="2760" &> run_LO_2760_15_30.log
