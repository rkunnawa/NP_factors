...
cmsRun anaGenJet_LO_cfg.py output="GenJet_LO_R23457_2760_July8_Z2pt50to80.root" maxEvents="100000" processType="NSD" ptHatLow="50" ptHatHigh="80" sqrtS="2760" &> run_LO_2760_50_80.log
