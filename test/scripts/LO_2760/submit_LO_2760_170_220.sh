...
cmsRun anaGenJet_LO_cfg.py output="GenJet_LO_R23457_2760_July8_Z2pt170to220.root" maxEvents="100000" processType="NSD" ptHatLow="170" ptHatHigh="220" sqrtS="2760" &> run_LO_2760_170_220.log
