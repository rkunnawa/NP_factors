...
cmsRun anaGenJet_LO_cfg.py output="GenJet_LO_R23457_2760_July8_Z2pt220to280.root" maxEvents="100000" processType="NSD" ptHatLow="220" ptHatHigh="280" sqrtS="2760" &> run_LO_2760_220_280.log
