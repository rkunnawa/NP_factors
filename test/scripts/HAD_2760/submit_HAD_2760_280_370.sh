...
cmsRun anaGenJet_HAD_cfg.py output="GenJet_HAD_R23457_2760_July8_Z2pt280to370.root" maxEvents="100000" processType="NSD" ptHatLow="280" ptHatHigh="370" sqrtS="2760" &> run_HAD_2760_280_370.log
