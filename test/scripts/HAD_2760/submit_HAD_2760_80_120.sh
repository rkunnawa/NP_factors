...
cmsRun anaGenJet_HAD_cfg.py output="GenJet_HAD_R23457_2760_July8_Z2pt80to120.root" maxEvents="100000" processType="NSD" ptHatLow="80" ptHatHigh="120" sqrtS="2760" &> run_HAD_2760_80_120.log
