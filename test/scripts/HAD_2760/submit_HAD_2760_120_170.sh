...
cmsRun anaGenJet_HAD_cfg.py output="GenJet_HAD_R23457_2760_July8_Z2pt120to170.root" maxEvents="100000" processType="NSD" ptHatLow="120" ptHatHigh="170" sqrtS="2760" &> run_HAD_2760_120_170.log
